package net.engineeringdigest.journalApp.config;//package net.engineeringdigest.journalApp.config;
//
//
...
//         CSRF configuration
        http.csrf(csrf -> csrf
                .ignoringRequestMatchers("/user/**","/journal/**")  // Disable CSRF protection for `/api/**` endpoints
                        .disable()
//                .requireCsrfProtectionMatcher(request ->
//                        "GET".equals(request.getMethod()))
        );  // Only apply CSRF protection for POST requests
